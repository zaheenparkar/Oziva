...
{
    public partial class frmTerRpt : Form
    {
        public frmTerRpt()
        {
            InitializeComponent();
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (strResult != "")
                {
                    ...
                    {
                        clsStandards.FillListView(lstView, objGen.BLGet_TerRpt(strResult, PL_Login.PlantCode.ToString(), rdbAll.Text));
                    }
                    else if (rdbRejected.Checked == true)
                    {
                        clsStandards.FillListView(lstView, objGen.BLGet_TerRpt(strResult, PL_Login.PlantCode.ToString(), rdbRejected.Text));
                    }
                    else if (rdbMapped.Checked == true)
                    {
                        clsStandards.FillListView(lstView, objGen.BLGet_TerRpt(strResult, PL_Login.PlantCode.ToString(), rdbMapped.Text));
                    }
        ...
        private void frmTerRpt_Load(object sender, EventArgs e)
        {
            rdbAll.Checked = true;
